/**
 * Amino Acid Specific Data & Logic
 */
...
function handleSmilesEdit(index, newSmiles) {
    ...
    try {
        smilesDrawer.draw(newSmiles, `#${canvasId}`, isDarkMode ? 'dark' : 'light'); // isDarkMode from global scope
    } catch (err) {
...
// Auto-init UI if DOM already loaded or on load
if (document.readyState === 'loading') {
    window.addEventListener('DOMContentLoaded', updateFilterUI);
} else {
    updateFilterUI();
}
